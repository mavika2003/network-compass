...
import { Map, MessageSquare, Search, Bell, User, Mic, LogOut } from 'lucide-react';
  ...
  return (
    <aside className="w-16 lg:w-56 h-screen bg-card border-r border-border flex flex-col shrink-0">
      ...
      <div className="p-3 space-y-2 border-t border-border">
        <div className="flex items-center justify-center lg:justify-start gap-2 px-3 py-2.5 rounded-lg bg-primary/10 text-primary text-sm cursor-pointer hover:bg-primary/20 transition-colors">
